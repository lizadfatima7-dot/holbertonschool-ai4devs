...
with open(r'C:\Users\Fatima\OneDrive\Desktop\bug_descriptions.md\smart_bug_bounty\bug_snippets\bug_descriptions.md', 'w', encoding='ascii', errors='replace') as f:
    f.write('\n'.join(lines))
print('Done')
"